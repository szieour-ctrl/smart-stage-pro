    ...
    messages: [{
      ...
      content: [
        ...
        { type: "text", text:
          ...
          "IMPORTANT FRAMING NOTE — read carefully, this depends on shot type:\n" +
          "For WIDE/ROOM shots (R01 Room Master, R02 Open Plan Lifestyle, R03 Foreground Depth): do not cluster your suggested crops toward the ceiling or upper portion of the frame — there is rarely anything worth featuring on blank ceiling. Bias these bboxes toward the foreground and floor-level two-thirds of the image, where furniture, fixtures, cabinetry, and staged assets actually are.\n" +
          "For FIXTURE/DETAIL shots where the fixture itself is mounted at or near the ceiling or extends toward the top of the frame — R11 Fixture Detail (chandeliers, pendant lights, ceiling fans, sconces mounted high), and any shot of a tall or arched window (R12, R01) — the OPPOSITE applies: the bbox MUST fully contain the entire fixture or window, including its topmost point, even if that means a y-origin near 0. A cropped-off chandelier, a pendant light cut off above the shade, or an arched window with the arch cut off is a failed shot, not a well-composed one. Never sacrifice showing the complete subject to satisfy a 'avoid the ceiling' bias — that bias only applies to wide/room shots, never to a shot whose entire purpose is that specific fixture.\n\n" +
          "GENERAL RULE: whatever the primary subject of a suggested shot is (a fixture, a window, an island, a furniture grouping), the bbox must fully contain that subject with reasonable margin on all sides — never crop through the middle of the actual subject the rule calls for.\n\n" +
