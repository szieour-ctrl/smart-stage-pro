/**
 * PHASE 5A — HAIKU SPATIAL READ PROMPT (FINAL REFINED)
 * 
 * CRITICAL REFINEMENT:
 * - NO directional language ("left of", "adjacent to", "between", "relative position")
 * - ONLY list what is "present in" or "attached to" the zone
 * - NO functional relationships ("associated with Kitchen")
 * - NO inference about zone proximity or adjacency
 * - Strict confidence thresholds per field
 * 
 * Replace entire Haiku prompt with this version.
 */
...
**zoneName:**
Exact zone type ONLY. Examples: "Kitchen", "Dining Zone", "Living/Great Room", "Hallway/Circulation", "Bedroom", "Entry/Foyer"

**boundaries:**
ONLY walls, partitions, openings physically visible IN this zone.
...
**fixtures:**
ONLY ceiling and wall-mounted fixtures physically located IN this zone at 70%+ confidence.
...
**cabinetry:**
ONLY built-in cabinetry physically present IN this zone at 70%+ confidence.
...
**windowsDoors:**
ONLY windows and doors that open FROM this zone at 70%+ confidence.
...
**anchorPoint:**
Tier 1 anchor (fireplace, ceiling fan, chandelier, etc.) physically located IN this zone at 60%+ confidence.
...
**focalPoint:**
Architectural feature or fixture physically located IN this zone at 70%+ confidence. NOT furniture placement.
...
**furnishing:**
EXACT instruction from logic rules above. Use zone name + anchor type to select correct instruction.
