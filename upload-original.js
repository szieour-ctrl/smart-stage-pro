...
async function uploadToCloudinary(imageBase64, mimeType, cloudName, uploadPreset, apiKey, apiSecret, listingId) {
  const ext  = (mimeType || "image/jpeg").includes("png") ? "png" : "jpg";
  const folder = listingId ? `smart-stage-originals/${listingId}` : "smart-stage-originals";
